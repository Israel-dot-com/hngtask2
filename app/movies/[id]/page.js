...
<aside id="cta-button-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 border-2 border-gray-400 border-solid" aria-label="Sidebar">
      ...
      <ul class="space-y-12 font-medium ">
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="ml-3">MovieBox</span>
            </a>
         </li>
         <li>
            <a href="/" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ml-3 whitespace-nowrap">TV Series</span>
            </a>
         </li>
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 group">
